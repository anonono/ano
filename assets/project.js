export default [{
    ...
    },
    {
        ...
        "data": {
            ...
            "category": "Designer",
            "status": "Delivery",
            "desc": "「<a href='http://donate.callsoverridges.org/' class='link' target='_blank'>遠山呼喚</a>」是來自台灣的國際非營利組織，自2015年尼泊爾震後幫助當地孩童重返學校，至今仍持續在尼泊爾協助孩子們透過教育完成脫貧的夢想。在這個專案上結合了組織的核心：小孩、山以及代表希望的氣球，並有各自帶有寓意的黃色、藍色與紅色，並以插畫的方式來述說這個故事。",
            "tags": '#Design',
        }
    },
    {
        ...
        "data": {
            ...
            "goals": ["納入新的資訊內容，並整合個別使用者所需的資訊到新規劃的個人首頁", "將舊有手機版網頁，重新設計為RWD網頁", "從Banner視覺選擇到元件設計，改變傳統產險形象"],
    ...
    },
    {
        ...
        "data": {
            ...
            "goals": ["將舊有電腦版網頁，重新設計為RWD網頁", "商品圖片與廣告共用舊版資料"],
            "tags": '#Design',
        }
    },
    {
        ...
        "data": {
            ...
            "goals": ["將舊有電腦版網頁，重新設計為RWD網頁", "利用艾普拉斯現有Logo、分析其TA與競業，延伸出適合公司的視覺形象"],
            "tags": '#Design',
        }
    },
    {
        ...
        "data": {
            ...
            "year": "2017 -",
            desc: "從「<a href='http://ww1.100daysui.com/?dn=100daysui.com&pid=1PO8G3V7O' class='link'  target='_blank'>100 Days UI Challenge</a>」羅馬尼雅設計師 Nechita Paul Flavius 挑戰 100天 UI 設計的作品網站開始，在網路上開始風行了 「<a href='http://www.dailyui.co/' class='link'>Daily UI</a>」挑戰，參加者會收到100個不同的Ui設計題目。自己希望能透過參加這個挑戰實驗不同的設計風格與互動，嘗試更多新的可能，目前正在朝此邁進中。",
            "category": "Planner / Designer",
    ...
    },
    {
        ...
        "data": {
            ...
            "goals": ["將舊有電腦版網頁，重新設計為RWD網頁", "圖片共用舊版資料"],
            "tags": '#Design',
